...
export default function ExceptionsPage() {
  ...
  const loadData = async () => {
    try {
      ...
      if (exceptionsError) {
        console.error('예외사항 로드 오류:', exceptionsError)
        toast.error('예외사항 데이터를 불러오는데 실패했습니다')
      } else {
  ...
  const getFilteredEmployees = () => {
    ...
    return employees.filter(emp => emp.store_id === formData.store_id)
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">예외사항 관리</h1>
          <p className="text-gray-600">스케줄 변경사항과 특별 근무를 관리하세요</p>
        </div>
        <Button 
          onClick={() => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setFormData({...formData, employee_id: value ? parseInt(value) : null})}
                      >
                        <SelectTrigger>
