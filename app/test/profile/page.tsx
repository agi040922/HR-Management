  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        {/* 헤더 */}
        <div className="text-center">
          <h1 className="text-3xl font-bold">사용자 프로필</h1>
          <p className="text-gray-600 mt-2">Supabase Auth 사용자 정보 및 관리</p>
        </div>
        ...
        <div className="flex justify-center space-x-4 text-sm">
          ...
          <Link href="/test/profile/edit" className="text-blue-600 hover:underline">
            프로필 편집
          </Link>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Supabase에서 관리하는 사용자 메타데이터</CardDescription>
          </CardHeader>
          <CardContent>
